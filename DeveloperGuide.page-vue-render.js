...
with(this){return _c('p',[_c('strong',[_v("System: TechConnect (TC)")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Use case: UC1 - Add a Company")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Actor: User")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User enters the detail of a company into the system")])]),_v(" "),_c('li',[_c('p',[_v("TC add the company to the contact list, and shows a success message to the user.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The input format is not correct.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. TC shows an error message.")])]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The given company already exists in the contact list.")]),_v(" "),_c('ul',[_c('li',[_v("3a1. TC will not add the company to the contact list.")])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("System: TechConnect (TC)")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Use case: UC2 - Remove a Company")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Actor: User")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User choose a company to remove from the contact list.")])]),_v(" "),_c('li',[_c('p',[_v("TC removes the company from the contact list, and shows a success message to the user.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The input format is not correct.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. TC shows an error message.")])]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("System: TechConnect (TC)")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Use case: UC3 - Show all Company")]),_v(" "),_c('br'),_v(" "),_c('strong',[_v("Actor: User")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to see all companies in the contact list.")])]),_v(" "),_c('li',[_c('p',[_v("TC shows all companies in the contact list.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("File storing user's data should be small and not exceed 10MB per 1000 companies and 10,000 tags")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("The app should have a simple and intuitive user interface.")]),_v(" "),_c('li',[_v("Data retrieval and saving should be reliable to prevent data loss")]),_v(" "),_c('li',[_v("The code should be modular and easily maintainable, following Java coding standards.")]),_v(" "),_c('li',[_v("The app should not require internet access, ensuring that the user's data remain private within their local system.")]),_v(" "),_c('li',[_v("The app should efficiently handle up to 1000 companies and 10,000 tags without a noticeable performance degradation.")]),_v(" "),_c('li',[_v("The application should be well-tested, with automated tests to ensure reliability and maintainability")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Fri, 4 Oct 2024, 18:45:19 GMT+8]")])])])}
}];
